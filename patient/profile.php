...
<html>
    ...
    <nav class="navbar navbar-expand-lg  navbar-info bg-info">
        <h5 class="text-white">Patient's Profile</h5>
                                ...
                                <?php 
                                    if(isset($_POST['update'])){
                                        ...
                                        if(empty($profile)){
                                            ...
                                            $query = "UPDATE patient SET profile = '$profile' WHERE username = '$user'";
                            ...
                            <div class="col-md-6">
                                ...
                                <?php 
                                    if(isset($_POST['change'])){
                                        ...
                                        if(empty($uname)){
                                            ...
                                            $q = "UPDATE patient SET username = '$uname' WHERE username ='$user'";
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['update_pass'])){
                                        ...
                                        $old = mysqli_query($connect, "SELECT * FROM patient WHERE username='$user'");
                                        ...
                                        if(count($error)==0){
                                            $query2 = "UPDATE patient SET password='$new_pass' WHERE username='$user'";
