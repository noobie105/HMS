        ...
        <ul class="navbar-nav">
            <?php
                if(isset($_SESSION['admin'])){
                    $ad = $_SESSION['admin'];
                    echo '<li class="nav-item"> <a href="#" class="nav-link text-white">'.$ad.'</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form method="POST">
                                    <?php 
                                        echo "<img src='img/$profile' class='col-md-12' style='height : 350px;' class='col-md-12' my-3>";
                                    ?>
                                     <br><br>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php 
                                    if(isset($_POST['change'])){
                                        ...
                                        if(empty($uname)){
                                            ...
                                            $q = "UPDATE admin SET username = '$uname' WHERE username ='$ad'";
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['update_pass'])){
                                        ...
                                        if(count($error)==0){
                                            $query2 = "UPDATE admin SET password='$new_pass' WHERE username='$ad'";
